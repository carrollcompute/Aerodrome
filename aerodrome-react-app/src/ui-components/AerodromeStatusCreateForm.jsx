...
export default function AerodromeStatusCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPiste_active(initialValues.piste_active);
    setArff(initialValues.arff);
    setAct_aviaire_locale(initialValues.act_aviaire_locale);
    setSar_statut(initialValues.sar_statut);
    setSar_statut_ytr(initialValues.sar_statut_ytr);
    setChamp_tir_9mm(initialValues.champ_tir_9mm);
    setChamp_planeur(initialValues.champ_planeur);
    setCircuit(initialValues.circuit);
    setAct_aviaire_migratoire(initialValues.act_aviaire_migratoire);
    setBase_rescue(initialValues.base_rescue);
    setSar_statut_yzx(initialValues.sar_statut_yzx);
    setGrande_anse(initialValues.grande_anse);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new AerodromeStatus(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "AerodromeStatusCreateForm")}
      {...rest}
    >
      <TextField
        label="Piste active"
